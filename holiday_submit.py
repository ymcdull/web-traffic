...
train_us=['2015-07-04','2015-11-26','2015-12-25']+['2016-07-04','2016-11-24','2016-12-26','2017-01-02','2017-01-16',
        '2017-02-20','2017-05-29','2017-07-04','2017-09-04']
test_us=['2017-10-09','2017-11-10']
train_uk=['2015-12-25','2015-12-28'] +['2016-01-01','2016-03-28','2016-05-02','2016-05-30','2016-12-26',
    '2016-12-27','2017-01-01','2017-04-14','2017-04-17','2017-05-01','2017-05-29','2017-08-28']
test_uk=[]
train_de=['2015-10-03', '2015-12-25', '2015-12-26']+['2016-01-01', '2016-03-25', '2016-03-26', '2016-03-27',
        '2016-01-01', '2016-05-05', '2016-05-15','2016-05-16', '2016-10-03', '2016-12-25', '2016-12-26','2017-04-14',
    '2017-04-17','2017-05-01','2017-05-25','2017-04-14','2017-06-05']
test_de=['2017-10-03']
train_fr=['2015-07-14', '2015-08-15', '2015-11-01', '2015-11-11', '2015-12-25']+['2016-01-01','2016-03-28',
        '2016-05-01', '2016-05-05','2016-05-08', '2016-05-16', '2016-07-14','2016-08-15', '2016-11-01',
    '2016-11-11', '2016-12-25','2017-04-17','2017-05-01','2017-05-08','2017-06-05','2017-07-14','2017-08-15']
test_fr=['2017-11-01','2017-11-11']
train_ru=['2015-11-04']+['2016-01-01', '2016-01-02', '2016-01-03', '2016-01-04', '2016-01-05', '2016-01-06', '2016-01-07',
        '2016-02-23', '2016-03-08', '2016-05-01', '2016-05-09', '2016-06-12', '2016-11-04','2017-01-01', '2017-01-02',
    '2017-01-03', '2017-01-04', '2017-01-05', '2017-01-06','2017-01-07','2017-02-23','2017-02-24','2017-03-08',
    '2017-05-01','2017-05-08','2017-05-09','2017-06-12']
test_ru=['2017-11-06']
train_es=['2015-08-15', '2015-10-12', '2015-11-01', '2015-12-06', '2015-12-08', '2015-12-25']+['2016-01-01',
        '2016-01-06', '2016-03-25', '2016-05-01', '2016-08-15', '2016-10-12', '2016-11-01','2016-12-06',
    '2016-12-08', '2016-12-25','2017-01-01', '2017-01-06','2017-04-14','2017-05-01','2017-05-02','2017-08-15']
test_es=['2017-10-12', '2017-11-01']
train_ja=['2015-07-20','2015-09-21', '2015-10-12', '2015-11-03', '2015-11-23', '2015-12-23']+['2016-01-01', '2016-01-11',
        '2016-02-11', '2016-03-20', '2016-04-29', '2016-05-03', '2016-05-04','2016-05-05', '2016-07-18', '2016-08-11',
    '2016-09-22','2016-10-10', '2016-11-03', '2016-11-23', '2016-12-23','2017-01-01', '2017-01-02',
    '2017-01-09', '2017-03-20','2017-05-03','2017-05-04','2017-05-05','2017-07-17']
test_ja=['2017-09-18', '2017-10-09', '2017-11-03']
train_zh=['2015-09-27', '2015-10-01', '2015-10-02','2015-10-03','2015-10-04','2015-10-05','2015-10-06','2015-10-07']+['2016-01-01',
        '2016-01-02', '2016-01-03', '2016-02-08', '2016-02-09', '2016-02-10', '2016-02-11','2016-02-12', '2016-04-04',
        '2016-05-01', '2016-05-02', '2016-06-09', '2016-06-10', '2016-09-15','2016-09-16', '2016-10-03', '2016-10-04',
        '2016-10-05','2016-10-06','2016-10-07','2017-01-02', '2017-01-27', '2017-01-30', '2017-01-31', '2017-02-01',
    '2017-02-02', '2017-02-27','2017-02-28', '2017-03-01','2017-04-03','2017-04-04','2017-05-01','2017-05-29',
    '2017-05-30']
test_zh=['2017-10-01', '2017-10-02','2017-10-03','2017-10-04','2017-10-05','2017-10-06']
train_o_zh=['2015-10-10','2016-02-06', '2016-02-14', '2016-06-12', '2016-09-18', '2016-10-08','2016-10-09',
        '2017-01-22', '2017-02-04','2017-04-01','2017-05-27']
test_o_zh=['2017-09-30']
...
test[['Id','Visits']].to_csv("holiday_tosubmit.csv", index = False)
